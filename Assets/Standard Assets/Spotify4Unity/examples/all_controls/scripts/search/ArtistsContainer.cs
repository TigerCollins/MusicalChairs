...
public class ArtistsContainer : SearchContainer<Artist>
{
    protected override void SetPrefabInfo(GameObject instantiatedPrefab, Artist artist)
    {
        ...
        {
            StartCoroutine(LoadImageFromUrl(artist.ImageUrl, Spotify4Unity.Enums.Resolution.Original, x => OnLoadedArtistPreview(instantiatedPrefab, x, instantiatedPrefab.GetComponentInChildren<Image>())));
        }
    }
